...
4.  **Sitzungs-Erstellung (`accessGrant`):**
    ...
    *   **Wichtig:** Dieser Grant speichert *keine* ID des ursprünglichen Zugangscodes. Er ist technisch völlig isoliert.
...
---
*Dieses Dokument dient dem Verständnis des MVP-Codes. Bei Erweiterungen sollte die Lösch-Logik stets auf Konsistenz geprüft werden.*
